...
export default async function handler(req, res) {
  ...
  const { group_name, entry_price, admin_pin } = req.body || {};
  ...
  await sql`
    INSERT INTO sweepstake_groups (group_code, group_name, entry_price, admin_pin)
    VALUES (${code}, ${group_name || 'Sweepstake'}, ${entry_price || '£5'}, ${String(admin_pin)})
  `;
